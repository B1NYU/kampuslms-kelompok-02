...
class UpdateCourseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'code' => [
                ...
                'max:20',
                'regex:/^[A-Z0-9-]+$/',
                // Kecualikan record yang sedang diedit. Nilai diambil dari route
                // model binding ({matkul}), BUKAN dari input form, agar tidak
                // bisa dimanipulasi pengguna.
                Rule::unique('courses', 'code')->ignore($this->route('matkul')),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'code.unique' => 'Kode ini sudah dipakai mata kuliah lain. Gunakan kode yang berbeda atau kembalikan ke kode semula.',
