                ...
                <div class="timeline-scroll-box">
                    @foreach ($pertemuanList as $minggu => $item)
                        @php
                            ...
                            // Pastikan materi diubah menjadi array agar aman
                            $materiList = (array) $item['materi'];
                            
                            // Encode ke JSON lalu escape
            ...
            <aside class="right-panel">
                ...
                <div id="detailRightPanel" class="content-fade" style="display: none;">
                    ...
                    <div class="card-week-detail-panel">
                        ...
                        <!-- Kontainer untuk Materi (Dirender dinamis) -->
                        <div class="detail-block">
                            <span class="detail-block-title">Materi & Berkas Perkuliahan</span>
                            <div class="materi-container" id="materiListContainer" style="display: flex; flex-direction: column; gap: 12px;">
                                <!-- Kartu-kartu materi dirender di sini oleh JavaScript -->
                            </div>
                        </div>

                        <!-- Kontainer untuk Penugasan (Dirender dinamis) -->
                        <div class="detail-block">
